...
public final class FemmeSalonCatalogBootstrapData {
  ...
  public static final List<ServiceRow> SERVICES =
      List.of(
          ...
          new ServiceRow("Ampolla", "Productos", BigDecimal.ZERO),
          new ServiceRow("Mousse", "Productos", BigDecimal.ZERO),
          ...
          new ServiceRow("Bar", "Productos", BigDecimal.ZERO),
          new ServiceRow("Cosméticos", "Productos", BigDecimal.ZERO),
