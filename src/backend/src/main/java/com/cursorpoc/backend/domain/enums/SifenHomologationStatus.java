 ...
 * Informative for the Platform Admin who decides — deliberately not a hard gate on the flag itself,
 * since a real tenant may legitimately need the flag on in the TEST SIFEN environment before
 * homologación is complete.
 */
