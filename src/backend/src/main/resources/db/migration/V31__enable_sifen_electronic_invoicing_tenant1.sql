-- Enables SIFEN_ELECTRONIC_INVOICING (V29) for tenant 1 via a per-tenant override, same row shape
...
-- Does not write to tenant_feature_flag_changes (V29): that table's changed_by_user_id/email
