...
-- codes, not free text. clients.department/clients.city (V20) only ever held free text, so
-- SifenDocumentXmlService could never actually emit these fields even when an address was
-- present. Same pattern as business_profiles' sifen_department_code/sifen_city_code (V22): a
