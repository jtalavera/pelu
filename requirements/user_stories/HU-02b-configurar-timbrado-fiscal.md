...
- **Pruebas:** límites de rango, cambio de timbrado activo, alertas (fechas y porcentaje simulados). Comportamiento al intentar **emitir** con timbrado inválido o agotado se valida en **HU-14**.
